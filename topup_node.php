...
<script src="https://credimax.gateway.mastercard.com/checkout/version/57/checkout.js"
        ...
        data-cancel="<?=$siteUrl?><?=$RELATIVE_PATH?>topup_node.php"
        data-complete="<?=$siteUrl?><?=$RELATIVE_PATH?>topup_nodes_response.php">//cancelCallback
</script>
