            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> <?php echo $languages[$lang]["viewReviews"];   ?></h4>
                                <ol class="breadcrumb">
                                    <li><a href="reviews_view.php?lang=<?php echo $lang; ?>"> <?php echo $languages[$lang]["reviews"];   ?> </a></li>
                                    <li class="active">  <?php echo $languages[$lang]["reviews"];   ?> </li>
                                </ol>
                            </div>
                        </div>
                        <input type="hidden" value="<?php echo $lang;   ?>" id="reviewLang">
                        <div class="panel">
                                    ...
                                    <table class="table table-striped" id="datatable-editable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $languages[$lang]["position"];   ?></th>
                                                <th><?php echo $languages[$lang]["review"];   ?></th>
                                        ...
                                        <tbody> <?php echo view_reviews($lang); ?> </tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
             ...
             $(".on-default").click(function () {
                    ...
                    let lang = $('#reviewLang').val();
                    // alert(category);
                    $("#dialogConfirm").click(function () {
                        // var dataString = 'family=' + family;
                        $.ajax({
                            type: "POST",
                            url: "functions/reviews_functions.php",
                            data: {
