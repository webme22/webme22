        ...
        <div id="wrapper">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (strlen($errors) > 4) {
                    ...
                    $con->query("insert into questions_categories (category_ar, category_en, date) values ('$category_ar','$category_en','".date('Y-m-d')."')") or die(mysqli_error($con));
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"><?php echo $languages[$lang]["add_category"];     ?></h4>
                                <ol class="breadcrumb">
                                ...
                                <div class="card-box">
                                    <form method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="category_ar"  required placeholder="<?php echo $languages[$lang]['category_ar'];  ?>" class="form-control" id="category_ar">
                                        </div>
                                        
                                        <div class="form-group col-md-6">
                                            <label for="category_en"><?php echo $languages[$lang]['category_en'];  ?> </label>
                                            <input type="text" name="category_en"  required placeholder="<?php echo $languages[$lang]['category_en'];  ?> " class="form-control" id="category_en">
                                        </div>
