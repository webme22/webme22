            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> <?php echo $languages[$lang]["viewQuestions"];   ?></h4>
                                <ol class="breadcrumb">
                                    <li><a href="questions_view.php?lang=<?php echo $lang; ?>"> <?php echo $languages[$lang]["questions"];   ?> </a></li>
                                ...
                                <div class="">
                                    <table class="table table-striped" id="datatable-editable">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th><?php  echo $languages[$lang]["category"];    ?></th>
                                                <th><?php  echo $languages[$lang]["question_ar"];    ?></th>
                                                <th><?php echo $languages[$lang]["question_en"];   ?></th>
                                                <th><?php  echo $languages[$lang]["answer_ar"];    ?></th>
                                                <th><?php echo $languages[$lang]["answer_en"];   ?></th>
                                        ...
                                        <tbody> <?php echo view_questions($lang); ?> </tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
