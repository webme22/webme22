            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> <?php echo $languages[$lang]["viewCountries"];   ?></h4>
                                <ol class="breadcrumb">
                                    <li><a href="countries_view.php?lang=<?php echo $lang; ?>"> <?php echo $languages[$lang]["countries"];   ?> </a></li>
                                    <li class="active">  <?php echo $languages[$lang]["countries"];   ?> </li>
                                </ol>
                            </div>
                        </div>
                        <input type="hidden" value="<?php echo $lang;   ?>" id="countryLang">
                        <div class="panel">
                                    ...
                                    <table class="table table-striped" id="datatable-editable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $languages[$lang]["key"];   ?></th>
                                        ...
                                        <tbody> <?php echo view_countries($lang); ?> </tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
             ...
             $(".on-default").click(function () {
                    ...
                    let lang = $('#countryLang').val();
                    // alert(category);
                    $("#dialogConfirm").click(function () {
                        // var dataString = 'family=' + family;
                        $.ajax({
                            type: "POST",
                            url: "functions/countries_functions.php",
                            data: {
