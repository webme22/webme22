            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> <?php echo $languages[$lang]["viewPlans"];   ?></h4>
                                <ol class="breadcrumb">
                                    <li><a href="plans_view.php?lang=<?php echo $lang; ?>"> <?php echo $languages[$lang]["plans"];   ?> </a></li>
                                    ...
                                    <table class="table table-striped" id="datatable-editable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $languages[$lang]["membersNum"];   ?></th>
                                                <th><?php echo $languages[$lang]["mediaUploads"];   ?></th>
                                        ...
                                        <tbody> <?php echo view_plans($lang); ?> </tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
